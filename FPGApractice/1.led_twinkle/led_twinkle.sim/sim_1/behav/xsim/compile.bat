...
REM
REM Generated by Vivado on Wed May 11 15:54:48 +0800 2022
...
echo "xvlog --incr --relax -prj tb_led_twinkle_vlog.prj"
call xvlog  --incr --relax -prj tb_led_twinkle_vlog.prj -log xvlog.log

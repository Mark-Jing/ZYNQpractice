...
REM
REM Generated by Vivado on Sat May 14 15:35:26 +0800 2022
...
echo "xvlog --incr --relax -prj sim_ip_clk_wiz_vlog.prj"
call xvlog  --incr --relax -prj sim_ip_clk_wiz_vlog.prj -log xvlog.log
